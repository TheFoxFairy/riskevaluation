...
INSERT INTO users(USER_ID, USER_NAME, PHONE) VALUES (1,"胡桃","123456789012");
INSERT INTO users(USER_ID, USER_NAME, PHONE) VALUES (2,"天海","123456789013");
INSERT INTO users(USER_ID, USER_NAME, PHONE) VALUES (3,"妖刀姬","123456789014");
...
(
    ...
    power_type  VARCHAR(30) COMMENT '权限名称',
    power_name  VARCHAR(30) COMMENT '权限URL',
    power_url  VARCHAR(30) COMMENT '权限图标',
    power_icon  VARCHAR(30) COMMENT '父权限ID',
    power_parent_id int(10) default -1
...
(
    role_id  NUMBER(10) NOT NULL COMMENT '角色ID',
    power_id NUMBER(10) NOT NULL COMMENT '权限ID'
